	...
	<table width="100%" border="0" cellspacing="0">
		<tr>
			<?php if(isset($_GET['excel'])){ ?>
				...
				<?php } ?>
			<td>
				<h4 style="margin-top: 10px;margin-left: -10px;">PEMBANGKIT LISTRIK TENAGA SAMPAH</h4>
				<h1 style="margin-top: -20px;margin-left: -10px;" >UCHIHA FOUNDATION</h1>
				<h5 style="margin-top: -20px;margin-left: -10px;">JL. Raden inten Jakarta Timur</h5>
			</td>
		</tr>
