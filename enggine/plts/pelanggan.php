							...
							<form method="post">
								<div class="col-md-12">
									...
									<div class="form-group">
										...
										<input type="text" name="id_rumah" class="form-control" placeholder="Masukan NO.RUMAH"  value="<?php if(@$_GET['id']==""){echo $id_rum;}else{ echo @$edit['id_rumah'];} ?>">
									</div>
									<div class="form-group">
										<label>NAMA</label>
